    ...
    function _getElementTransformValues(element) {
        ...
        if (transform.indexOf('rotate') !== -1) {
            rotateAr = transform.slice((transform.indexOf('rotate') + 7), -1).split(' ');
        ...
        return {
            ...
            rotate: rotateAr || [0, center, center] //real value or default
        };
    }

    function _updateTransformValues(element, newValues) {
        var newTransform = 'matrix(' + newValues.matrix.join(' ') + ') rotate(' + newValues.rotate.join(' ') + ')'
    ...
    el.selectToScaleElement = function(e) {
        ...
        function _downScale(e) {
            if (parseInt(currentRadius) < 1) {
                ...
                currentRadius = Number(currentRadius) - 1;
            }
            selectedElement.setAttributeNS(null, 'r', currentRadius);
        }
    ...
    el.selectToRotate = function(event) {
