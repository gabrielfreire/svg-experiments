 ...
 * TODO
 */
el.selectToDragControlPoint = function(event, controlPoint, elementToBeMoved, svgContainer) {
    ...
    function deselect(event) {
        ...
        controlPoint.removeEvent('mousemove', scaleX);
        controlPoint.removeEvent('mouseup', deselect);
        ...
        // controlPoint.removeEvent('mouseout', deselect);
    }
    // Control point events
    controlPoint.addEvent('mousemove', scaleX);
    controlPoint.addEvent('mouseup', deselect);
