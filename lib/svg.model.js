/**
 * @class {SVGElement} Element creator class
 */
...
svg.createCircle = function(cx, cy, r, isControlPoint) {
 ...
 */
svg.createControlPoint = function(x, y, r, color, parentElement) {
    var posX = x || '0',
        posY = y || '0',
        ray = r || '3',
        id = 0,
        ...
        element = svgEl.createCircle(posX, posY, ray, true);
